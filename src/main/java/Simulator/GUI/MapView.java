...
public class MapView extends StackPane {
    ...
    private Stage stage;
    public MapView(GrassMap map,Stage stage,StatTrack statTrack,Config config){

        this.objectSize = config.getObjectSize();
    ...
    public void drawAnimals(GraphicsContext g){
        for(Animal animal : this.map.getAnimalsList()){
            ...
            //depth of animal color indicating energy level
